...
export const DayCell: React.FC<DayCellProps> = React.memo(({ data, config, isToday, onClick, onMouseEnter, onMouseLeave }) => {
  ...
  if (isToday) {
    ...
    if (hasOutput) {
        ...
        ringClass = 'ring-2 ring-inset';
        customBorderStyle = { borderColor: activeTheme.hex };
    }
  }
  ...
  return (
    ...
    >
        ...
        <span 
          className={`${textSizeClass} leading-none select-none ${textClass} tracking-tighter relative z-10`}
